...
### Q: "VPS 端 lisa 报错找不到配置"

A: 确认 Xray 配置路径正确。编辑 /root/lisa.py 顶部的 CONF 变量。
...
A: 编辑 lisa.py，搜索 days=30 改为你需要的天数。
